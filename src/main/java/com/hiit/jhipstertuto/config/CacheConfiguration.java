package com.hiit.jhipstertuto.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.hiit.jhipstertuto.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.hiit.jhipstertuto.repository.UserRepository.USERS_BY_EMAIL_CACHE);
